 ...
 * @returns {Promise<any>}
 */
    const dynamoQuery = async (tableName: string, partitionKey: string, value: any, asc: boolean = true, consistentRead: boolean = true): Promise<DocumentClient.QueryOutput> => {
