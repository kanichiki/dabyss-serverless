...
export const main = async (userNumber: number, positionNumberList: number[]): Promise<line.Message[]> => {
  ...
  return [

    {
      "type": "flex",
      "altText": "役職人数確認",
      "contents": await jinro_module.positionNumberMessage(userNumber, positionNumberList)
    },
    {
      "type": "flex",
      "altText": "役職確認",
